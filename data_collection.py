...
if __name__ == "__main__":
    ...
    zed = sl.Camera()
    dir_path = "/home/daniel/Documents/ISL-Projects-main/TurtlebotZED/data_test"
    EXPERIMENT = 'image_test'
    ...
    initial_translation.init_vector(0, 0.5, 0)
   ...
   # Configure object detection runtime parameters
    ...
    print(camera_infos.camera_configuration.resolution.width)
    point_cloud = sl.Mat(camera_infos.camera_configuration.resolution.width, camera_infos.camera_configuration.resolution.height, sl.MAT_TYPE.F32_C4, sl.MEM.CPU) # Potentially changing to GPU
    objects = sl.Objects()
    image_left = sl.Mat()

    # Utilities for 2D display
    display_resolution = sl.Resolution(camera_infos.camera_configuration.resolution.width, camera_infos.camera_configuration.resolution.height)
